...
VCC and ALCOM can choose from up to the three newest supported AvatarRecovery versions listed in this repository. Refresh the repository in your client if a newly published version does not appear immediately.
